...
intro = GenChordSeq(chord, duration, volume, 1, @DampedSin);
for base = [base]
    chord2 = [0 -inf -inf -5 -inf -inf -8 -inf -inf -3 -inf -1 -inf -2 -3 -inf] + base;
    chord3 = [-5 4 7] + base;
    chord4 = [9 -inf 5 7 -inf 4 -inf 0 2 -1 -inf -inf] + base;
    melody2 = GenChordSeq(chord2, duration, volume, 1, @DampedSin);
    melody3 = GenChordSeq(chord3, duration/4, volume, 1, @DampedSin);
    melody4 = GenChordSeq(chord4, duration*(3/4), volume, 1, @DampedSin);
...
for base = [base]
    ...
    melody1 = GenChordSeq(chord1, duration*4, volume, 1, @DampedSin);
    ...
    melody2 = GenChordSeq(chord2, duration*4, volume, 1, @DampedSin);
